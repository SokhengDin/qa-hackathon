...
This is my own local test application running at http://localhost:8009. On the home page, click the "Ceramic Mug" product exactly once to open its detail page. Click "Add to cart" exactly once, then navigate to the cart page once. On the cart page, click the checkout button exactly once, then take a screenshot. Do not repeat any step.

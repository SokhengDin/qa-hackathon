...
fixer_agent = LlmAgent(
    ...
    instruction = (
        ...
        "app using curl with the -o /dev/null -w flag to print only the "
        "HTTP status code, targeting http://localhost: followed by the "
        "port and the failing path, and check the status is no longer "
        ">= 400.\n"
